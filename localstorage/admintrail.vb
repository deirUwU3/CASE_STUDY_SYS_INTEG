...
Public Class admintrail
    ...
    Private Sub admintrail_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        auddittr.Items.Clear()
        trail()
    End Sub
    Private Sub trail()
        auddittr.Items.Add("Faculty Login")
        auddittr.Items.Add("Student Login")
        auddittr.Items.Add("Faculty Update")
    End Sub

    Private Sub auddittr_SelectedIndexChanged(sender As Object, e As EventArgs) Handles auddittr.SelectedIndexChanged
        datav.DataSource = Nothing
        If auddittr.Text = "Faculty Login" Then
            ...
            Using conn As MySqlConnection = Data.GetConnection()
                Try
                    ...
                    Dim query As String = "
                 SELECT 
      facultyid, role, logintime, logouttime 
         FROM 
     facultytrail"
                ...
                End If
            End Using
        ElseIf auddittr.Text = "Student Login" Then
            Dim Dataview As New DataTable()
            Using conn As MySqlConnection = Data.GetConnection()
                Try
                    If conn.State = ConnectionState.Closed Then conn.Open()
                    ...
                    Dim query As String = "
                 SELECT 
      studentid, platform,logintime, logouttime 
         FROM 
     studenttrail"
                ...
                End If
            End Using
        ElseIf auddittr.Text = "Faculty Update" Then
            Dim Dataview As New DataTable()
            Using conn As MySqlConnection = Data.GetConnection()
                Try
                    If conn.State = ConnectionState.Closed Then conn.Open()
                    ...
                    Dim query As String = "
                 SELECT 
      updid	Faculyid,	Input,	studentid,	subjectid,	gradeid	Time 	 
         FROM 
     facultyupd"
